        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          <Stack spacing={4}>
            ...
            <Text color={"gray.500"} fontSize={"sm"}>
              ...
              tomorrow, today. We are also contributing to the pace of
              digitisation of India by working closely with traditional banks to
              increase ease and convenience for last-mile customers.
            </Text>
            <Stack
              spacing={4}
              divider={
